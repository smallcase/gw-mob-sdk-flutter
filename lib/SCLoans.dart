...
class SCLoans {
  ...
  static Future<String?> setup(
    ...
    try {
      setupResponse = await _channel.invokeMethod('setup', <String, dynamic>{
        "gateway": gateway,
  ...
  static Future<String?> pay(
    ...
    try {
      payResponse = await _channel.invokeMethod('apply', <String, dynamic>{
        "interactionToken": interactionToken,
      });
    } on PlatformException catch (e) {
      payResponse = e.code;
  ...
  static Future<String?> withdraw(
    ...
    try {
      withdrawResponse = await _channel.invokeMethod('apply', <String, dynamic>{
        "interactionToken": interactionToken,
      });
    } on PlatformException catch (e) {
